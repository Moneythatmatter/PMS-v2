...
export function FunctionSheetsBEOView() {
  ...
  const handleCreateBEOFromBooking = async (booking: CentralBookingItem) => {
    ...
    const newBEO: BEOItem = {
      ...
      venueName: booking.venueOrRoom,
      expectedPax: booking.guestCount || 0,
      guaranteedPax: booking.guestCount || 0,
      ...
      signageBoard: false,
      mealServiceTypes: [],
      menuSelection: booking.menuRequirement || "",
      dietaryRequirements: "",
      projector: false,
      ledScreen: false,
      soundSystem: false,
      ...
      avitNotes: "",
      securityNotes: "",
      contractValue: booking.contractValue || 0,
      advanceStatus: booking.advanceReceived ? `₹${booking.advanceReceived.toLocaleString("en-IN")} Received` : "Pending",
      createdAt: "Today",
      updatedAt: "Today",
      timeline: [
        {
          id: `LOG-${Date.now()}`,
          timestamp: "Just now",
          action: `BEO Draft Created from Booking #${booking.bookingId}`,
